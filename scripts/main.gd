...
var letter_list = {summer: [], fall: [], winter: [], spring: []} # Values for all of these will be generated in _generate_letter_list!
var seasons = [summer, fall, winter, spring] # empty this out until empty, then check if empty: do something?
var visited_kingdoms = [] # Make sure all suitors are visited.
...
## Returns: Array of generated letters in random order.
...
func _hover_on(sprite, pos) -> void:
	sprite.set_position(pos + Vector2(0, -15))
